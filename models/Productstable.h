...
class Productstable
{
  public:
    struct Cols
    {
        ...
        static const std::string _colors;
    };
     ...
     */
    explicit Productstable(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Productstable(const Json::Value &pJson) noexcept(false);
     ...
     */
    Productstable(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column colors  */
    ///Get the value of the column colors, returns the default value if the column is null
    const std::string &getValueOfColors() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getColors() const noexcept;
    ///Set the value of the column colors
    void setColors(const std::string &pColors) noexcept;
    void setColors(std::string &&pColors) noexcept;
    void setColorsToNull() noexcept;
  ...
  private:
    friend drogon::orm::Mapper<Productstable>;
    friend drogon::orm::BaseBuilder<Productstable, true, true>;
    friend drogon::orm::BaseBuilder<Productstable, true, false>;
    friend drogon::orm::BaseBuilder<Productstable, false, true>;
    friend drogon::orm::BaseBuilder<Productstable, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Productstable>;
#endif
    ...
    std::shared_ptr<std::string> colors_;
    struct MetaData
    {
