...
class Usercase
{
  public:
     ...
     */
    explicit Usercase(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Usercase(const Json::Value &pJson) noexcept(false);
     ...
     */
    Usercase(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Usercase>;
    friend drogon::orm::BaseBuilder<Usercase, true, true>;
    friend drogon::orm::BaseBuilder<Usercase, true, false>;
    friend drogon::orm::BaseBuilder<Usercase, false, true>;
    friend drogon::orm::BaseBuilder<Usercase, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Usercase>;
#endif
